...
const RxCursor = (function(){
     ...
     * 
     * @param {function} func
     * @returns {object} object - the return value of the func
     */
     ...
     * 
     * @returns {Number} number - a new instance of RxCursor
     */
     ...
     * 
     * @returns {Object} object - The object returned from the cursor
     */
    ...
    RxCursor.prototype.whileHasNext = function(){
        return this.rxCursor.flatMap(cursor => RxMongo.whileHasNext(cursor));
    }

    /**
     * Returns the first value from the cursor. Undefined is returned if the cursor contains no items.
     * 
     * @returns {Object} object - The first object returned from the cursor
     */
     ...
     * 
     * @returns {Array} array - the results
     */
